	...
	:renderer(renderer), Interior(this, renderer)
{
	...
	auto PredefName = [](const std::string_view sv){
		return BlockIdentifiyer::ParsePredefined(sv);
	};

	AddCompressedData(
		CompressedBlockData{
		.blockExteriorData = {
			.Identifiyer = PredefName(SevenSeg),
			.ShowIdentifiyer = false,
			.Size = {2,3},
			.InputPin = {
				{.Rotation = Down, .Offset = 1,.Multiplicity = 7},
				{.Rotation = Down, .Offset = 2},
			},
		},
		});
	...
	AddCompressedData(
		CompressedBlockData{
		.blockExteriorData = {
			.Identifiyer = PredefName(SixteenSeg),
			.ShowIdentifiyer = false,
			.Size = {2,3},
			.InputPin = {
				{.Rotation = Down, .Offset = 1,.Multiplicity = 16},
				{.Rotation = Down, .Offset = 2},
			},
		}
		});
	AddCompressedData(
		CompressedBlockData{
		.blockExteriorData = {
			.Identifiyer = PredefName(And),
			.Size = {2,2},
			.InputPin = {
				{.Rotation = Down, .Offset = 0, .Round = true},
				{.Rotation = Down, .Offset = 2, .Round = true},
				},
			.OutputPin = {
				{.Rotation = Up, .Offset = 1, .Round = true},
			},
		}
		});
	AddCompressedData(
	...
	AddCompressedData(
		CompressedBlockData{
		.blockExteriorData = {
			.Identifiyer = PredefName(Mux),
			.ShowIdentifiyer = false,
			.Size = {2,2},
			.InputPin = {
				{.Rotation = Down, .Offset = 0,.Multiplicity = 128},
				{.Rotation = Down, .Offset = 2,.Multiplicity = 128},
				{.Rotation = Right, .Offset = 1},
				},
			.OutputPin = {
				{.Rotation = Up, .Offset = 1,.Multiplicity = 128},
			},
		}
		});
	AddCompressedData(
		CompressedBlockData{
		.blockExteriorData = {
			.Identifiyer = PredefName(Driver),
			.ShowIdentifiyer = false,
			.Size = {0,0},
			.InputPin = {
				{.Rotation = Up, .Offset = 0, .Round = true},
				{.Rotation = Right, .Offset = 0},
				},
			.OutputPin = {
				{.Rotation = Down, .Offset = 0, .Round = true},
			},
	...
	AddCompressedData(
		CompressedBlockData{
		.blockExteriorData = {
			.Identifiyer = PredefName(ToggleButton),
			.ShowIdentifiyer = false,
			.Size = {0,0},
			.OutputPin = {
				{.Rotation = Down, .Offset = 0, .Round = true},
	...
	AddCompressedData(
		CompressedBlockData{
		.blockExteriorData = {
			.Identifiyer = PredefName(Constant),
			.ShowIdentifiyer = false,
			.Size = {0, 0},
			.OutputPin = {
				{.Rotation = Neutral, .Offset = 0, .Round = true},
			},
		}
		});
	AddCompressedData(
	...
	AddCompressedData(
		...
		.blockExteriorData = {
			...
			.Size = {2,2},
			.InputPin = {
				{.Rotation = Up, .Offset = 1, .Multiplicity = 1,.Name = "i0"},
				{.Rotation = Left, .Offset = 1, .Multiplicity = 1,.Name = "i1"},
				{.Rotation = Down, .Offset = 1, .Multiplicity = 1,.Name = "i2"},
				{.Rotation = Right, .Offset = 1, .Multiplicity = 1,.Name = "i3"},
				},
		}
		});
	AddCompressedData(
	...
	AddCompressedData(
		...
		.blockExteriorData = {
			...
			.Size = {17,5},
			.InputPin = {
				{.Rotation = Up, .Offset = 1, .Multiplicity = 1,.Name = "C In"},
				{.Rotation = Left, .Offset = 0, .Multiplicity = 1,.Name = "i1"},
				{.Rotation = Left, .Offset = 1, .Multiplicity = 1,.Name = "i2"},
				{.Rotation = Left, .Offset = 2, .Multiplicity = 1,.Name = "i3"},
				{.Rotation = Left, .Offset = 3, .Multiplicity = 1,.Name = "i4"},
				},
			.OutputPin = {
				{.Rotation = Down, .Offset = 1, .Multiplicity = 1,.Name = "C Out"},
				{.Rotation = Right, .Offset = 0, .Multiplicity = 1,.Name = "o1"},
				{.Rotation = Right, .Offset = 1, .Multiplicity = 1,.Name = "o2"},
				{.Rotation = Right, .Offset = 2, .Multiplicity = 1,.Name = "o3"},
				{.Rotation = Right, .Offset = 3, .Multiplicity = 1,.Name = "o4"},
			},
		}
		});
}
