...
flat in vec2 XOrBase1;
flat in vec2 XOrBase2;
flat in vec2 XOrControllNear;
...
//    vec2 fardiff = PosInWorld-FarPoint;
	...
	d = min(d, sdBezier(PosInWorld, XOrBase1, XOrControllNear, XOrBase2)-  0.1);
...
//	   FragColor = vec4(UHighlightColor, 1.0 - 5.0 * d);
